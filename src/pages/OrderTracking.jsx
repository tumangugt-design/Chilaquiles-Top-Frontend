          ...
          <>
            ...
            <div className="text-center">
              <p className="text-gray-400 font-bold text-xs uppercase tracking-[0.2em] mb-4">
                Mientras esperas, síguenos en redes sociales
              </p>
              <div className="flex items-center justify-center gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:border-transparent transition-all group"
                  aria-label="Instagram"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-brand-black group-hover:text-white transition-colors">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center hover:bg-black hover:border-black transition-all group"
                  aria-label="TikTok"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-brand-black group-hover:text-white transition-colors">
